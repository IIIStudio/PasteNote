...
PasteNote 是一款基于游览器侧边栏笔记扩展，帮助用户快速记录和管理知识碎片。支持从当前页面一键捕获链接、8 色笔记系统、GitHub 风格活跃度热力图、图片上传、腾讯云 COS 云端同步，以及右键快捷插入笔记。
...
https://microsoftedge.microsoft.com/addons/detail/pastenote/nghodiikfbjefielfngnfflhjhhnliac
